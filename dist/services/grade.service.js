...
const create = (reqBody) => __awaiter(void 0, void 0, void 0, function* () {
    return yield Grade_1.default.create(reqBody);
});
const query = () => __awaiter(void 0, void 0, void 0, function* () {
    return yield Grade_1.default.find();
});
const getById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield Grade_1.default.findById(id);
});
const updateById = (id, updateBody) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield Grade_1.default.findByIdAndUpdate(id, updateBody, { new: true });
    if (!result) {
...
const deleteById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Grade_1.default.findByIdAndRemove(id);
    return result;
});
exports.default = {
    create,
